...
import (
	"Credits/configs"
	"Credits/internal/security"
	"Credits/internal/server"
	"Credits/pkg/db"
	"Credits/pkg/logger"
	"errors"
	"fmt"
...
// @title Credits portal API
// @version 1.0.0

// @description API Server for portal Credits
// @BasePath /
...
func main() {
	...
	err = server.ServiceShutdown()
	if err != nil {
		fmt.Println("Error while shutting down program")
		return
	}
